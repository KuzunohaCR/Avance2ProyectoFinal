...
CREATE TABLE `albumartista` (
  `idalbumartista` int NOT NULL AUTO_INCREMENT,
  `nombrealbumartista` varchar(45) NOT NULL,
  PRIMARY KEY (`idalbumartista`)
...
INSERT INTO `albumartista` VALUES (1,'pipi');
...
-- Dump completed on 2020-12-04 23:17:30
